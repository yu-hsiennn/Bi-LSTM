...
from model.model_joints import Joints_info

class AnimePlot():
    def __init__(self, joints_info : Joints_info):
        self.fig = plt.figure()
        self.ax = []
        self.joint = joints_info.get_joint()
        self.jointChain = joints_info.get_joints_chain()
